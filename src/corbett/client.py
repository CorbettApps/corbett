...
class Client:
    ...
    def register(self, email, password):
        ...
        return self.send("POST", "/users", json={"email": email, "password": password})
    ...
    def login(self, email, password):
        ...
        return self.send("POST", "/login", json={"email": email, "password": password})
    ...
    def register_app(self, app_type):
        return self.send("POST", "/apps", json={"app_type": app_type})
